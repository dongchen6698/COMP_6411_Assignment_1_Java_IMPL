...
public class Kruskal {
	public static void main(String[] args) {
		...
		ArrayList<Integer> nodes = getNodesList(nodesCount);
		ArrayList<ArrayList<Integer>> edges = getEdgeList(nodesCount, filePath);
		
		//Sort the Edges based on weight
		ArrayList<ArrayList<Integer>> sortedEdges = sortEdges(edges);
		
		// Execute the Kruskal function and measure the time
		long startTime = System.currentTimeMillis();
		ArrayList<ArrayList<Integer>> result_mst = Kruskal(nodes, sortedEdges);
		...
		ArrayList<Edge> edgesList = generateEdgeList(result_mst);
		
		// Output and format result to file
		fromResultToFile(nodesCount,edgesList,durationTime,memory);
	...
	public static ArrayList<ArrayList<Integer>> Kruskal(ArrayList<Integer> nodes, ArrayList<ArrayList<Integer>> edges){
